...
| EV-GATEC-OP-RETENTION-002 | WORM, legal hold, and disposition | Stage 1 offline COMPLETE; Stage 2 Governance provisioning COMPLETE (2026-08-25); Stage 3 Governance QA next | Stage 3 requires approved synthetic test-object QA matrix; legal hold/disposition prohibited; canary disabled until QA PASS | `docs/management/decisions.md`, `docs/architecture/EV-GATEC-OP-RETENTION-002-backend-contract.md` |
